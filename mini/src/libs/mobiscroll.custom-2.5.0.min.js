(function (a) {
  function u(j, b) {
    ...
    function o(j, c, b, f, i) {
      !1 !== N("validate", [z, c, j]) && (a(".dw-ul", z).each(function (b) {
        var d = a(this), e = a('.dw-li[data-val="' + n.temp[b] + '"]', d), h = a(".dw-li", d), g = h.index(e), p = h.length, l = b == c || void 0 === c;
        if (!e.hasClass("dw-v")) {
    ...
    function u(j) {
      if (!("inline" == p.display || S === a(window).width() && ca === a(window).height() && j)) {
        var c, b, e, d, f, i, g, h, m, l = 0, q = 0, j = a(window).scrollTop();
        d = a(".dwwr", z);
        var I = a(".dw", z), n = {};
        ...
        "modal" == p.display ? (b = (S - V) / 2, e = j + (O - P) / 2) : "bubble" == p.display ? (m = !0, h = a(".dw-arrw-i", z), b = f.offset(), i = b.top, g = b.left, d = f.outerWidth(), f = f.outerHeight(), b = g - (I.outerWidth(!0) - d) / 2, b = b > S - V ? S - (V + 20) : b, b = 0 <= b ? b : 20, e = i - P, e < j || i > j + O ? (I.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"),
          e = i + f) : I.removeClass("dw-bubble-bottom").addClass("dw-bubble-top"), h = h.outerWidth(), d = g + d / 2 - (b + (V - h) / 2), a(".dw-arr", z).css({left: d > h ? h : d})) : (n.width = "100%", "top" == p.display ? e = j : "bottom" == p.display && (e = j + O - P));
        n.top = 0 > e ? 0 : e;
        n.left = b;
        I.css(n);
    ...
    var ha, M, Q, z, S, O, ca, V, P, T, ia, n = this, da = a.mobiscroll, R = j, G = a(R), ea, ja, p = H({}, ka), aa = {}, $ = [], W = {}, fa = {}, Y = G.is("input"), X = !1;
    n.enable = function () {
      p.disabled = !1;
      Y && G.prop("disabled", !1)
    };
    ...
    n.show = function (j) {
      ...
      d += ("inline" != p.display ? '<div class="dwbc' + (p.button3 ? " dwbc-p" : "") + '"><span class="dwbw dwb-s"><span class="dwb">' + p.setText + "</span></span>" + (p.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' + p.button3Text + "</span></span>" : "") + '<span class="dwbw dwb-c"><span class="dwb">' + p.cancelText + "</span></span></div></div>" : '<div class="dwcc"></div>') + "</div></div></div>";
      z = a(d);
      o();
      N("onMarkupReady", [z]);
    ...
    n.init = function (a) {
      ea =
        H({defaults: {}, init: r}, da.themes[a.theme || p.theme]);
  ...
  function l(j, b, c, e, d) {
    var b = t(b, f, s), i = a(".dw-li", j).eq(b), g = void 0 === d ? b : d, h = E, l = e ? b == g ? 0.1 : Math.abs(0.1 * (b - g)) : 0;
    x.temp[h] =
      i.attr("data-val");
    x.scroll(j, h, b, l, d);
    setTimeout(function () {
  ...
  var g = {}, C, r = function () {
  }, i, f, s, x, q = (new Date).getTime(), h, A, v, E, w, y, K, D, F, c, b = document.createElement("modernizr").style, e = k(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]), d = function () {
    var a = ["Webkit", "Moz", "O", "ms"], b;
    for (b in a)if (k([a[b] + "Transform"]))return "-" +
      a[b].toLowerCase();
    return ""
  }(), H = a.extend, L, J, Z = "touchstart mousedown", I = "touchmove mousemove", la = function (a) {
    ...
    parseValue: function (a, b) {
      var c =
        b.settings.wheels, e = a.split(" "), d = [], f = 0, h, g, i;
      for (h = 0; h < c.length; h++)for (g in c[h]) {
        if (void 0 !== c[h][g][e[f]])d.push(e[f]); else for (i in c[h][g]) {
          d.push(i);
          break
        }
        f++
  ...
  a(document).bind("touchend mouseup", function () {
    if (h) {
      var b = new Date - K, e = t(D + (w - y) / i, f - 1, s + 1), d, g = v.offset().top;
  ...
  a.mobiscroll = a.mobiscroll || {
      setDefaults: function (a) {
        ...
        this.shorts[a] = function (b) {
          return m(this, H(b, {preset: a}), arguments)
        }
...
(function (a) {
  a.mobiscroll.i18n.hu = a.extend(a.mobiscroll.i18n.hu, {setText: "OK", cancelText: "M\u00e9gse"})
})(jQuery);
(function (a) {
  a.mobiscroll.i18n.de = a.extend(a.mobiscroll.i18n.de, {setText: "OK", cancelText: "Abbrechen"})
})(jQuery);
(function (a) {
  a.mobiscroll.i18n.es = a.extend(a.mobiscroll.i18n.es, {setText: "Aceptar", cancelText: "Cancelar"})
})(jQuery);
(function (a) {
  a.mobiscroll.i18n.fr = a.extend(a.mobiscroll.i18n.fr, {setText: "Termin\u00e9", cancelText: "Annuler"})
})(jQuery);
(function (a) {
  a.mobiscroll.i18n.it = a.extend(a.mobiscroll.i18n.it, {setText: "OK", cancelText: "Annulla"})
})(jQuery);
(function (a) {
  a.mobiscroll.i18n.no = a.extend(a.mobiscroll.i18n.no, {setText: "OK", cancelText: "Avbryt"})
})(jQuery);
(function (a) {
  a.mobiscroll.i18n["pt-BR"] = a.extend(a.mobiscroll.i18n["pt-BR"], {setText: "Selecionar", cancelText: "Cancelar"})
})(jQuery);
(function (a) {
  var u = a.mobiscroll, k = new Date, o = {
    dateFormat: "mm/dd/yy",
    dateOrder: "mmddy",
    timeWheels: "hhiiA",
    timeFormat: "hh:ii A",
    ...
    var f = a.extend({}, o, C, k.settings), s = 0, C = [], x = [], q = {}, h, A = {
    ...
    }, v = f.preset, B = f.dateOrder, w = f.timeWheels, y = B.match(/D/), K = w.match(/a/i), D = w.match(/h/), F = "datetime" == v ? f.dateFormat + f.separator + f.timeFormat : "time" == v ? f.timeFormat : f.dateFormat, c = new Date, b = f.stepHour, e = f.stepMinute, d = f.stepSecond, H = f.minDate || new Date(f.startYear, 0, 1), L = f.maxDate || new Date(f.endYear, 11, 31, 23, 59, 59);
    k.settings = f;
    r = r || F;
    if (v.match(/date/i)) {
      a.each(["y", "m", "d"], function (a, b) {
        h = B.search(RegExp(b, "i"));
        -1 < h && x.push({o: h, v: b})
      });
      x.sort(function (a,
                       b) {
      ...
      for (i = 0; 3 > i; i++)if (i == q.y) {
        s++;
        g[f.yearText] = {};
        var J = H.getFullYear(), Z = L.getFullYear();
    ...
    if (v.match(/time/i)) {
      ...
      } else i == q.a && (s++, v = w.match(/A/), g[f.ampmText] = {"0": v ? "AM" : "am", 1: v ? "PM" : "pm"});
      C.push(g)
    }
    ...
    return {
      button3Text: f.showNow ? f.nowText : void 0, button3: f.showNow ? function () {
      ...
      headerText: function () {
        ...
        var g = k.temp, h = {y: H.getFullYear(), m: 0, d: 1, h: 0, i: 0, s: 0, a: 0}, i = {
          y: L.getFullYear(),
          m: 11,
          d: 31,
          h: l(D ? 11 : 23, b),
        ...
        a.each("y,m,d,a,h,i,s".split(","), function (b, d) {
          if (q[d] !== void 0) {
            var e = h[d], l = i[d], r = 31, k =
              t(g, d), F = a(".dw-ul", c).eq(q[d]), s, o;
            if (d == "d") {
              s = t(g, "y");
              o = t(g, "m");
              l = r = 32 - (new Date(s, o, 32)).getDate();
              y && a(".dw-li", F).each(function () {
                var b = a(this), c = b.data("val"), d = (new Date(s, o, c)).getDay(), c = B.replace(/[my]/gi, "").replace(/dd/, c < 10 ? "0" + c : c).replace(/d/, c);
            ...
            if (d != "y") {
              var J = a(".dw-li", F).index(a('.dw-li[data-val="' + e + '"]', F)), u = a(".dw-li", F).index(a('.dw-li[data-val="' + l + '"]', F));
  ...
  u.formatDate = function (k, t, l) {
    if (!t)return null;
    var l = a.extend({}, o, l), m = function (a) {
    ...
    for (r = 0; r < k.length; r++)if (f)"'" == k.charAt(r) && !m("'") ? f = !1 : i += k.charAt(r); else switch (k.charAt(r)) {
      case "d":
        i += g("d", t.getDate(),
          2);
        break;
      ...
      case "y":
        ...
        break;
      case "h":
        var s = t.getHours(), i = i + g("h", 12 < s ? s - 12 : 0 == s ? 12 : s, 2);
        break;
      case "H":
        i += g("H", t.getHours(), 2);
        break;
  ...
  u.parseDate = function (k, t, l) {
    var m = new Date;
    if (!k || !t)return m;
    var t = "object" == typeof t ? t.toString() : t + "", g = a.extend({}, o, l), u = g.shortYearCutoff, l = m.getFullYear(), r = m.getMonth() + 1, i = m.getDate(), f = -1, s = m.getHours(), m = m.getMinutes(), x = 0, q = -1, h = !1, B = function (a) {
    ...
    for (y = 0; y < k.length; y++)if (h)"'" == k.charAt(y) && !B("'") ? h = !1 : w++; else switch (k.charAt(y)) {
      case "d":
        i = v("d");
        break;
      case "D":
...
(function (a) {
  var u = a.mobiscroll, k = {invalid: [], showInput: !0, inputClass: ""}, o = function (o) {
    function u(g, c, b, e) {
      for (var d = 0; d < c;) {
        var f = a(".dwwl" + d, g), i = t(e, d, b);
    ...
    var f = a.extend({}, k, o.settings), s = a(this), x, q, h = this.id + "_dummy", A = 0, v = 0, E = {}, w = f.wheelArray || i(s), y = function (a) {
      var c = [], b;
...
(function (a) {
  var u = {inputClass: "", invalid: [], rtl: !1, group: !1, groupLabel: "Groups"};
  ...
  a.mobiscroll.presets.select = function (k) {
    ...
    var t = k.settings, l = a.extend({}, u, t), m = a(this), g = m.prop("multiple"), C = this.id + "_dummy", r = g ? m.val() ? m.val()[0] : a("option", m).attr("value") : m.val(), i = m.find('option[value="' + r + '"]').parent(), f = i.index() + "", s = f, x;
    a('label[for="' + this.id + '"]').attr("for", C);
    var q = a('label[for="' + C + '"]'), h = void 0 !==
    l.label ? l.label : q.length ? q.text() : m.attr("name"), A = [], v = [], E = {}, w, y, K, D, F = t.readonly;
    ...
    return {
      width: 50, wheels: void 0, headerText: !1, multiple: g, anchor: D, formatResult: function (a) {
        return E[o(a[y])]
      }, parseValue: function () {
        var c = m.val() || [], b = 0;
        if (g) {
      ...
      onClose: function () {
        ...
        setValue: function (c, b, e) {
          return this.each(function () {
            ...
            if (d)if (d.setSelectVal)d.setSelectVal(c, b, e); else {
              d.temp = c;
              d.setValue(true, b, e)
            }
          })
...
(function (a) {
  a.mobiscroll.themes.android = {defaults: {dateOrder: "Mddyy", mode: "clickpick", height: 50}}
})(jQuery);
(function (a) {
  var u = {defaults: {dateOrder: "Mddyy", mode: "mixed", rows: 5, width: 70, height: 36, showLabel: !1}};
...
(function (a) {
  a.mobiscroll.themes.wp = {
    defaults: {width: 70, height: 76, accent: "none", dateOrder: "mmMMddDDyy"},
    init: function (u, k) {
      var o, B;
  ...
  $.mobiscroll.i18n.zh = $.extend($.mobiscroll.i18n.zh, {
    ...
    hourText: '时',
    minuteText: '分',
    monthNames: ['01', '02', '02', '04', '05', '06', '07', '08', '09', '10', '11', '12'],
    monthNamesShort: ['01', '02', '02', '04', '05', '06', '07', '08', '09', '10', '11', '12'],
    monthText: '月',
    secText: '秒',
    timeFormat: 'HH:ii',
    timeWheels: 'HHii',
